...
class KeyboardWidget(QDialog):
    ...
    def initUI(self):
        ...
        self.text_box.setMaximumHeight(60)
        ...
        clear_button.setMaximumHeight(27)
        ...
        space_button.setMaximumHeight(27)
        ...
        back_button.setMaximumHeight(27)
        ...
        enter_button.setMaximumHeight(27)
        ...
        done_button.setMaximumHeight(27)
        ...
        self.cap_button.setMaximumHeight(27)
        ...
        sym_button.setMaximumHeight(27)
    ...
    def buttonClicked(self, char_ord):
        ...
        if char_ord == Qt.Key_Up:
            ...
            txt = txt[:-1]
            self.new_pass_txt = self.new_pass_txt[:-1]
        elif char_ord == Qt.Key_Enter:
            txt += chr(10)
            self.new_pass_txt += chr(10)
        elif char_ord == Qt.Key_Home:
            if self.text_box_name == 'user_name':
                self.dataModel.set_user_name(txt)
                self.currentTextBox.setText(txt)
                print("User Name: " + self.dataModel.get_user_name())
            elif self.text_box_name == 'user_pass':
                print("pass save: " + self.new_pass_txt)
                self.dataModel.set_user_pass(self.new_pass_txt)
                self.currentTextBox.setText(self.asterisker(txt))
                self.new_pass_txt = ''
                print("User Pass: " + self.dataModel.get_user_pass())
            ...
            txt += chr(char_ord)
            self.new_pass_txt += chr(char_ord)

        if self.text_box_name == 'user_name':
            self.text_box.setText(txt)
        elif self.text_box_name == 'user_pass':
            self.text_box.setText(self.asterisker(txt))
            print("New : " + self.new_pass_txt)
    ...
    def asterisker(self, word, guesses=[]):
        result = ""
        for letter in word:
    ...
    def closeEvent(self, event):
        close = QMessageBox.question(self,
                                     "QUIT",
                                     "Are you sure want to close keyboard?",
...
class cQLineEdit(QLineEdit):
    ...
    def __init__(self, widget, name, dataModel, text_box_name):
        ...
        self.ex.currentTextBox.setFixedHeight(33)
        self.ex.currentTextBox.setFixedWidth(212)
    ...
    def mousePressEvent(self, QMouseEvent):
        print("MouseEvent: " + str(QMouseEvent))
        self.ex.show()
        self.clicked.emit()

    def returnKeyObject(self):
        return self.ex
