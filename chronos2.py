...
class Chronos2:
    def __init__(self, ui, changed_play_image, changed_pause_image):
        self.start = ui.startChrono2
        self.reset = ui.resetChrono2
        self.ui = ui.chronos2
        self.changed_pause_image = changed_pause_image
        self.changed_play_image = changed_play_image
        self.TICK_TIME = 2 ** 6
        # ==================Stop Watch =============================================================================
    ...
    def convert(self, seconds):
        ...
        minutes = seconds // 60
        seconds %= 60
        self.ui.setText(str("%02d:" % hour) + "" + str(
