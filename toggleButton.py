from PyQt5.QtCore import QObject, QSize, QPointF, QPropertyAnimation, QEasingCurve, pyqtProperty, pyqtSlot, Qt, QRect, \
    QRectF, QPoint
from PyQt5.QtGui import QPainter, QPalette, QLinearGradient, QGradient, QTextDocument
